...
const cardVariants = cva("rounded-2xl text-card-foreground", {
  variants: {
    variant: {
      ...
      raised: "border border-border/60 bg-surface-raised shadow-lift",
      ghost: "bg-transparent",
      dashed: "border border-dashed border-border bg-surface-muted",
      brand:
        "border-0 bg-brand-gradient text-primary-foreground shadow-brand",
    },
    interactive: {
      true: "transition-transform duration-150 ease-spring active:scale-[0.99] md:hover:shadow-lift",
    },
  },
  defaultVariants: {
    variant: "default",
